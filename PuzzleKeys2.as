package 
{
	...
	public class PuzzleKeys2
	{
		...
		public function PuzzleKeys2(checkBT : SimpleButton, myTimeline : MovieClip, linha : MovieClip, myStage : Stage, dots:Array)
		{
			...
			for(var j=0;j<dots.length;j++){
				dots[j].addEventListener(MouseEvent.MOUSE_DOWN,Colponto_Mouse);
			...
			{					
					...
					if(linhaselected){
						...
						if(pontoselected!= aux){
							...
							else if(nlinhascertas ==1 && (pontoselected == 4 && aux == 8 )){
								nlinhascertas++;
							}
							else if(nlinhascertas ==2 && (pontoselected == 8 && aux == 11 )){
								nlinhascertas++;
							}
							else if(nlinhascertas ==3 && (pontoselected == 11 && aux == 5 )){
								nlinhascertas++;
							}
							else if(nlinhascertas ==4 && (pontoselected == 5 && aux == 16 )){
								nlinhascertas++;
							}
							else if(nlinhascertas ==5 && (pontoselected == 16 && aux == 18 )){
								nlinhascertas++;
								trace("ganhei");
								ganhei = 1;
						...
						if((nlinhaserradas>=6) || (nlinhascertas + nlinhaserradas>6)){
							trace("perdeste");
							trace(dotguardadas);
